...
rep(OLD1, NEW1, "1. summary pagination")
...
rep(OLD2, NEW2, "2. summary percentages")

OLD3 = ('        if S.get("ordId") and st=="\u59d4\u8a17\u4e2d": '
        'api("POST","/api/v5/trade/cancel-order",{"instId":S["spec"]["iid"],"ordId":S["ordId"]})\n')
NEW3 = ('        sweep_orphans(S["spec"]["iid"],"long" if S["dir"]=="L" else "short")\n')
rep(OLD3, NEW3, "3. /stop cancels via OKX")

OLD4 = ('            if S.get("ordId") and S["state"]=="\u59d4\u8a17\u4e2d": '
        'api("POST","/api/v5/trade/cancel-order",{"instId":S["spec"]["iid"],"ordId":S["ordId"]})\n')
NEW4 = ('            sweep_orphans(S["spec"]["iid"],"long" if S["dir"]=="L" else "short")\n')
rep(OLD4, NEW4, "4. /stopall cancels via OKX")
